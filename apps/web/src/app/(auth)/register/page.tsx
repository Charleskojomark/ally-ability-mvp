            ...
            <div className="w-full max-w-md animate-fade-up">
                ...
                <div className="bg-white rounded-3xl shadow-xl shadow-charcoal/5 p-8 sm:p-10 border border-brand-amber/10">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-heading font-bold text-charcoal">Create Account</h1>
                        <p className="text-charcoal/60 font-body mt-1">Join the inclusive learning community</p>
                    </div>
                    ...
                    <form action={register} className="space-y-4">
                        ...
                        <button
                            className="w-full gradient-warm text-white font-bold py-3.5 rounded-xl hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 mt-2"
                            id="register-submit"
                        >
                            Create Account
                        </button>
